...
public class passengers implements Serializable {
    ...
    public passengers(String naMe, String last_Name1, Long Dni, Long phone, String email1) {
        this.naMe = naMe;
    ...
    public passengers(Long id, String name, String last_Name, Long dni, Long phone_Number, String email) {
        this.id = id;
        this.naMe = name;
        this.last_Name = last_Name;
        this.dni = dni;
